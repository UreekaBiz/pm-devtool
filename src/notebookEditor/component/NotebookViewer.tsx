...
// == Interface ====================================================================
interface Props { content: NotebookDocumentContent; }
...
export const NotebookViewer: React.FC<Props>= ({ content }) => {
  ...
  return (<div id={NOTEBOOK_VIEWER_ID} className={`${EDITOR_CLASS_NAME} ${EDITOR_PREVIEW_CLASS_NAME}`}/*SEE: /index.css*/ dangerouslySetInnerHTML={{ __html: htmlContent ?? '' }} />);
};

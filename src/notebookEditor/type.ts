...
import { Rectangle } from './extension/svg/shape/rectangle/Rectangle';
...
import { SVGNode as SVG } from './extension/svg/SVGNode';
...
export const editorDefinition = {
  ...
  extensions: [ Bold, DropCursor, Document, GapCursor, Heading, Highlight, History, NodeViewRemoval, Paragraph, Rectangle, SetDefaultMarks, Style, SVG, Text, TextStyle, UniqueNodeId ],

import { getRenderAttributes, AttributeType, CodeBlockAttributes, CodeBlockComponentJSX, CodeBlockNodeRendererSpec, CodeBlockNodeSpec, CodeBlockNodeType, NodeName } from 'common';

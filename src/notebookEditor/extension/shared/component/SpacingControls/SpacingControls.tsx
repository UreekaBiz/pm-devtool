...
import { isMarginAttribute, getOppositeSpacingAttribute, AttributeType, InvalidMergedAttributeValue, Margin, MarginAttribute, Padding, PaddingAttribute, SpacingAttribute, SpacingType } from 'common';
...
export const SpacingControls: React.FC<Props> = ({ margin, padding, name, onChange }) => {
  ...
  const getValue = (type: SpacingType, attribute: SpacingAttribute) => {
    ...
    const editorValue = mergedValue === InvalidMergedAttributeValue ? undefined/*invalid*/ : mergedValue;

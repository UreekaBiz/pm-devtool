import { AttributeType, UnorderedListAttributes, SetAttributeType } from 'common';
...
export const UnorderedListAttrs: NodeExtensionAttributes<UnorderedListAttributes> = {

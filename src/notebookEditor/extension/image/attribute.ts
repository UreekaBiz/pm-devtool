import { AttributeType, SetAttributeType, ImageAttributes, DEFAULT_IMAGE_BORDER_COLOR, DEFAULT_IMAGE_BORDER_STYLE, DEFAULT_IMAGE_BORDER_WIDTH, DEFAULT_IMAGE_WIDTH, DEFAULT_IMAGE_HEIGHT, NodeName } from 'common';
...
export const ImageAttrs: NodeExtensionAttributes<ImageAttributes> = {
  // creates a new Id for the Node when it is created
  [AttributeType.Id]:  uniqueIdParsingBehavior(NodeName.IMAGE),

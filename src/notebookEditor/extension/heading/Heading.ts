...
import { createBoldMark, createMarkHolderNode, getBlockNodeRange, generateNodeId, getHeadingLevelFromTag, getNodeOutputSpec, stringifyMarksArray, AttributeType, HeadingLevel, HeadingNodeSpec, SetAttributeType } from 'common';

...
import { createBoldMark, getBlockNodeRange, generateNodeId, isHeadingLevel, isHeadingNode, AttributeType, CommandFunctionType, HeadingLevel, NodeName, MarkName, NodeIdentifier } from 'common';

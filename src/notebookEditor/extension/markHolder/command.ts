...
import { getMarkName, isMarkActive, stringifyMarksArray, AbstractDocumentUpdate, AttributeType, Command, MarkName, MarkHolderNodeType, NotebookSchemaType, SetMarkDocumentUpdate, UnsetMarkDocumentUpdate } from 'common';

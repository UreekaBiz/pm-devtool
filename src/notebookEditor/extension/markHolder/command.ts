...
import { getMarkName, isMarkActive, stringifyMarksArray, AbstractDocumentUpdate, AttributeType, Command, MarkName, MarkHolderNodeType, UnsetMarkDocumentUpdate, SetMarkDocumentUpdate } from 'common';

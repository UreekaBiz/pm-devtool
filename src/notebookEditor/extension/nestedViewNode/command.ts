 ...
 *
 */
export const nestedViewNodeBehaviorCommand = (outerView: EditorView, nodeType: NodeType, closeNodeCursorPos: 'before' | 'after', wouldLeaveInnerView: boolean): Command => (state, dispatch) => {
  // (SEE: NOTE below)

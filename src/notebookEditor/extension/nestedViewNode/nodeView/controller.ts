        ...
        plugins: [keymap(
          {
            ...
            'Enter': chainCommands(insertNewlineCommand(this.node.type.name as NodeName/*by definition*/), nestedViewNodeBehaviorCommand(this.nodeView.outerView, this.node.type, 'after'/*place cursor after the Node*/, true/*meant to leave the inner View*/)),

...
import { isMarkActive, isNodeActive, NodeName, MarkName, Attributes } from 'common';
...
export class Editor {
  ...
  public mountView(root: HTMLElement) {
    const props: DirectEditorProps = {
      state: EditorState.create({
        doc: DOMParser.fromSchema(this.schema).parse(new window.DOMParser().parseFromString('<ul><li><div data-node-type="paragraph">asdasd</div></li><li><div data-node-type="paragraph">b</div></li><li><div data-node-type="paragraph">c</div></li></ul>', 'text/html')),
  ...
  // FIXME: why is they combined? They should be separate
  // .. Node or Mark ..............................................................
  /**

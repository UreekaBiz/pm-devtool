  ...
  public mountView(root: HTMLElement) {
    const props: DirectEditorProps = {
      state: EditorState.create({
        doc: DOMParser.fromSchema(this.schema).parse(new window.DOMParser().parseFromString('<ul><li><div data-node-type="paragraph">asd</div></li></ul><div data-node-type="paragraph">asd</div>', 'text/html')),

...
export const removeNull = <T extends Record<string, any>>(o: T) => removeValue(o, null)/*for convenience*/;
export const removeUndefined = <T extends Record<string, any>>(o: T) => removeValue(o, undefined)/*for convenience*/;
